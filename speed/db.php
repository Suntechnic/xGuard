...
// запишим время в лог
$LogFile = __DIR__.'/logs/db.log.txt';
...
if (file_exists($LogFile) && filesize($LogFile) > $MaxLogSize) {
    ...
    copy($LogFile, __DIR__.'/logs/db.log.old.txt');
    // очистим текущий лог
